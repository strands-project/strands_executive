...
public class PrismTest
{
	...
	/**
	 * args[0] is the model file
	 * args[1] is the properties file
	 * Test like this:
	 * PRISM_MAINCLASS=prism.PrismTest bin/prism tests/ex2.prism tests/ex2.prism.props 
	 */
	public void go2(String args[])
	{
		try {
			PrismLog mainLog;
			Prism prism;
			...
			prism.setExportProductStatesFilename("adv.sta");
